...
.grad {
	background-image: linear-gradient(to bottom left, Teal, white, Red);
...
.p4 {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/anshul.jpg');
						...
						<div class="card-body">
							...
							<div class="text-center">
								<a href="<%=ORSView.FORGET_PASSWORD_CTL%>"
									style="color: white; font-size: 15px;"><b>Forgot my
										password ?</b></a>
							</div>
